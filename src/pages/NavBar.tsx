  ...
  return (
    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 text-gray-300'>
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[0px] duration-300 border border-blue-600'>
            <a
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[0px] duration-300 border border-[#333333]'>
            <a
              className='flex justify-between items-center w-full text-gray-300 '
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[0px] duration-300 border border-[#6fc2b0]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[0px] duration-300 border border-[#565f69]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
